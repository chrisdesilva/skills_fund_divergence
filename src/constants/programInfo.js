...
export const leadContent = {
    ...
    paragraph: `${schoolName} designs its programs to provide students a foundation for a career in data science or cyber security. ${schoolName} partners with Skills Fund to offer tuition${faq.costOfLiving ? ' and cost of living' : ''} financing so more students like you can access their program.`
}
...
export const programLoanInfo = [ // update with program names and corresponding loan URLs with market segment code from Master Loan Parameters
    {
        name: "Cyber Security",
        url: "https://sf.privateloan.studentloan.org/external/LoanApplication.do?lenderCode=SKDVCP17",
    ...
    },
    {
        ...
        url: "https://sf.privateloan.studentloan.org/external/LoanApplication.do?lenderCode=SKDVDS17",
        loanInfo: { // match loanInfo in first metro below
            maxLoanAmt: 21500,
            loanTerm36: true,
            loanTerm60: true,
...
export const programMaxText = "Choose the loan amount that works best for you. Borrow up to $18,000 for Cyber Security Penetration Testing tuition and up to $4,500 for cost of living or up to $17,000 for Data Science Immersive tuition and up to $4,500 for cost of living."
